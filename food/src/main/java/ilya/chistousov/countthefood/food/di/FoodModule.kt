...
import ilya.chistousov.countthefood.food.data.repository.ProfileRepositoryImpl
...
interface FoodModule {
    ...
    @Binds
    fun bindGetProfileRepository(profileRepositoryImpl: ProfileRepositoryImpl) : ProfileRepository
