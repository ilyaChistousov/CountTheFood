package ilya.chistousov.countcalories.presentation.tabs
...
class TabsFragment : BaseFragment<FragmentTabsBinding>(
    ...
    private fun setBackgroundColorBottomNav() {
        binding.bottomNavViewTabs.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.light_green))
    }
